...
const path_nomenclatures_new_DB = path.join(__dirname,'..', '..', 'DB', 'nomenclatures_new.json')
const path_suppliers_new_DB = path.join(__dirname,'..', '..', 'DB', 'suppliers_new.json')
const path_nomenclatures_hit_DB = path.join(__dirname,'..', '..', 'DB', 'nomenclatures_new.json')
const path_suppliers_hit_DB = path.join(__dirname,'..', '..', 'DB', 'suppliers_new.json')
module.exports.path_nomenclatures_DB = path_nomenclatures_DB
module.exports.path_nomenclatures_new_DB = path_nomenclatures_new_DB
module.exports.path_nomenclatures_hit_DB = path_nomenclatures_hit_DB
module.exports.path_contractors_DB = path_contractors_DB
module.exports.path_suppliers_DB = path_suppliers_DB
module.exports.path_suppliers_new_DB = path_suppliers_new_DB
module.exports.path_suppliers_hit_DB = path_suppliers_hit_DB
